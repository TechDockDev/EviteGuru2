   ...
   return (
      <Stack
            ...
            {guests.map((guest, index) => {
               return (
                  <Grid
                     ...
                     xs={12}
                     display="flex"
                     sx={{ flexDirection: { xl: "row", sm: "row", xs: "column" }, border: { xl: "none", sm: "none", xs: "1px solid grey" }, padding: { sm: "0", xs: "8px" }, borderRadius: { sm: "0", xs: "10px" }, mb: { sm: 0, xs: 1 } }}>
                     {/* First Name */}
                     <TextField
                        type={"text"}
                        mt={1}
                     ...
                     <TextField
                        mt={1}
                        type="number"
                        sx={{ marginX: "5px", "& .MuiInput-root:before": { borderBottom: "2px dashed #DB4437" } }}
                        fullWidth
                        id="`phone`"
                        name="phone"
         ...
         <Box width="100%" textAlign="center" >
            <Button variant="contained" type="submit" sx={{color:"white", width:"150px"}} >
            Submit
            </Button>
         </Box>
      </Stack>
